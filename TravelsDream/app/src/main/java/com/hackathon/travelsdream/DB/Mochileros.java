...
public class Mochileros extends SQLiteOpenHelper {

    private static final String DB_NAME = "DB_Mochileros.sqlite";
    private static final int DB_VERSION = 1;

    private static final String MOCHILEROS_TABLE_CREATE = "CREATE TABLE mochileros(_id INTEGER PRIMARY KEY AUTOINCREMENT," +
            "nick TEXT, name TEXT, lastName TEXT, email TEXT, mobile TEXT, passWord TEXT)";

    public Mochileros(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(MOCHILEROS_TABLE_CREATE);
